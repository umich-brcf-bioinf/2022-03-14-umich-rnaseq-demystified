...
First, we'll create a new code file, using the toolbar at the top of our window and clicking the icon that looks like white square with a small green plus symbol.
...
After we've created the necessary directories, we'll use the blue floppy disc icon save our 'Untitled1' file as "DE_Analysis.R".
...
*TODO:Update data import from built in files*
